...
public class MimeMessage extends Message implements MimePart {
    ...
    public void setFrom(String address) throws MessagingException {
        if (address == null) {
            ...
            setAddressHeader("From", (Address[]) InternetAddress.parse(address));
        }
    }
    ...
    public Address[] getRecipients(Message.RecipientType type) throws MessagingException {
        if (type == RecipientType.NEWSGROUPS) {
            ...
            return (s == null) ? null : (Address[]) NewsAddress.parse(s);
        }
    ...
    public void setRecipients(Message.RecipientType type, String addresses) throws MessagingException {
        if (type == RecipientType.NEWSGROUPS) {
            ...
            setAddressHeader(getHeaderName(type), (addresses == null) ? null : (Address[]) InternetAddress.parse(addresses));
        }
    ...
    public void addRecipients(Message.RecipientType type, String addresses) throws MessagingException {
        if (type == RecipientType.NEWSGROUPS) {
            ...
            addAddressHeader(getHeaderName(type), (Address[]) InternetAddress.parse(addresses));
        }
    }
    ...
    private Address[] getAddressHeader(String name) throws MessagingException {
        ...
        return (s == null) ? null : (Address[]) InternetAddress.parseHeader(s, this.strict);
    }
    ...
    protected InputStream getContentStream() throws MessagingException {
        ...
        if (this.content != null) {
            return (InputStream) new SharedByteArrayInputStream(this.content);
        }
    ...
    public Message reply(boolean replyToAll, boolean setAnswered) throws MessagingException {
        ...
        if (replyToAll) {
            ...
            if (alternates != null) {
                eliminateDuplicates(v, (Address[]) InternetAddress.parse(alternates, false));
            }
    ...
    private Address[] eliminateDuplicates(Vector<InternetAddress> v, Address[] addrs) {
        ...
        if (gone != 0) {
            ...
            if (addrs instanceof InternetAddress[]) {
                a = (Object[]) new InternetAddress[addrs.length - gone];
            } else {
                a = (Object[]) new Address[addrs.length - gone];
            }
