...
public class Response {
    ...
    public Response() {
        this.buffer = this.buffer = ASCIIUtility.getBytes("");
    ...
    public String readAtom(char delim) {
        ...
        byte b;
        while (this.index < this.size && (b = this.buffer[this.index]) > 32 && b != 40 && b != 41 && b != 37 && b != 42 && b != 34 && b != 92 && b != Byte.MAX_VALUE && (delim == '\000' || b != delim)) {
            this.index++;
        }
